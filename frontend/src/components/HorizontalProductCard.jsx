          ...
          ? loadingList.map((product, index) => {
              return (
                <div
                  ...
                  key={index + 1}
                >
                  <div className="bg-slate-500 animate-pulse h-full p-4 min-w-[120px] md:min-w-[145px]"></div>
                  <div className="p-4 grid gap-1">
                    ...
                    <div className="flex gap-3 items-center ">
                      <p className="text-green-600 font-medium h-6 animate-pulse ">
                        {Currency(product?.sellingprice)}
                      </p>
                      <p className="text-slate-300 line-through h-6 animate-pulse">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 grid">
                    ...
                    <button
                      className="bg-red-500 hover:bg-red-700 py-0.5 px-3 rounded-full text-white text-center text-sm hover:scale-110 transition-all"
                      onClick={(e) => {
