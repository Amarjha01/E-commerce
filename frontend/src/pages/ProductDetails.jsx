...
<div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 mix-blend-multiply flex justify-center items-center">
{data.productImage[0] && <img src={activeImage} alt="product" className="h-[90%] w-[90%] object-scale-down mix-blend-multiply"/>}
</div>
...
<div className="flex gap-2 lg:flex-col overflow-scroll h-full animate-pulse">
  {
       productImageloading.map(el =>{
          return(
          <div className="h-36 w-36 bg-slate-200 rounded ">
    ...
    <div className="flex gap-2 lg:flex-col overflow-scroll h-full">
    {
         data?.productImage?.map((imageUrl,index) =>{
            return(
            <div className="h-32 w-32 bg-slate-200 rounded flex justify-center items-center "  key={imageUrl} >
            <img src={imageUrl} onMouseEnter={()=>{setActiveImage(imageUrl)}} onClick={()=>{setActiveImage(imageUrl)}}  alt="product"  className="h-28 w-28 object-scale-down mix-blend-multiply cursor-pointer"/>
        ...
        {/* product detain */}
        {
          ...
          <div className="flex gap-2">
            ...
            <p className="text-slate-300 line-through animate-pulse">{Currency()}</p>
          </div>
          <div className="flex gap-2 ">
          ...
          (
            <div className="px-2 w-full flex flex-col gap-1">
          <p className="bg-green-200 text-red-600 inline w-fit  font-bold px-3 rounded-full">{data.brandName }</p>
          ...
          <div className="flex gap-2 ">
            <button className="border-2 border-red-600  px-3 py-1 rounded-md  text-xl text-red-500 font-medium min-w-[120px] hover:bg-red-500 hover:text-white transition-all ">Buy</button>
            <button className="border-2 border-red-600  px-3 py-1 rounded-md text-xl text-white font-medium min-w-[120px] bg-red-500 hover:bg-red-700 hover:text-white transition-all">Add to cart</button>
          </div>
          <div>
